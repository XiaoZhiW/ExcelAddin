...
(function () {
    ...
    async function createTable() {
        await Excel.run(async (context) => {
            ...
            expensesTable.rows.add(null /*add at the end*/, [
                ["12/1/2023", "The Phone Company", "Communications", "120"],
                ["12/2/2023", "Northwind Electric Cars", "Transportation", "142"],
                ["12/5/2023", "Best For You Organics Company", "Groceries", "27"],
                ["12/10/2023", "Coho Vineyard", "Restaurant", "33"],
                ["12/11/2023", "Bellows College", "Education", "350"],
                ["12/15/2023", "Trey Research", "Other", "135"],
                ["12/15/2023", "Best For You Organics Company", "Groceries", "97"]
            ]);
    ...
    async function createChart() {
        await Excel.run(async (context) => {
            ...
            chart.legend.format.fill.setSolidColor("black");
